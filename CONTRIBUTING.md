...
Thanks for considering a contribution to notty! Following
...
opening a new issue, search [existing issues](https://github.com/Winipedia/notty/issues)
to avoid duplicates.
...
- All checks in [CI](https://github.com/Winipedia/notty/actions/workflows/health_check.yml) must pass before merge.
