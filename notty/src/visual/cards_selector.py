...
class CardsSelector:
    ...
    def __init__(
        ...
        self.card_buttons: list[MultiCardButton] = []
    ...
    def _get_selected_cards(self) -> list["VisualCard"]:
        """Get the list of currently selected cards.

        Returns:
            List of selected cards.
        """
        return [button.card for button in self.card_buttons if button.selected]
    ...
    def _update_submit_button_state(self) -> None:
        ...
        if self.submit_button:
            self.submit_button.enabled = len(
                selected_cards
            ) > 0 and self.validation_func(selected_cards)
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    if self.submit_button and self.submit_button.is_clicked(
                        ...
                        return self._get_selected_cards()
